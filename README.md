# [SOLVED] How-Do-I-Access-In-Game-Key-Binding-Settings-In-Skyrim-Ae-Wh
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-do-i-access-in-game-key-binding-settings-in-skyrim-ae-wh)
>
...
Try using the game's built-in console command 'tgm' to enable the game's debug mode, then press the 'T' key to open the console. Type 'player.addperk SkyrimScriptEnhanced' and press Enter to enable the ScriptEnhanced perk, which allows you to access the in-game controls menu.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-do-i-access-in-game-key-binding-settings-in-skyrim-ae-wh)**
